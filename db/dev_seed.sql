...
-- 3. Пользователь учебного офиса
INSERT INTO "user" (id_role, name, surname, fathername)
VALUES
(
...
VALUES
(
    (SELECT id_user FROM "user" WHERE surname = 'Смирнова' AND name = 'Елена'),
    'office1',
    'office123'
);
...
-- 5. Студенты (по 4 на каждую группу)
...
-- 7. Enrollment и teaching assignment на основе ваших реальных записей
