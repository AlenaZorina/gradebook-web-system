...
import "./OfficeStudentDetailsPage.css";

type OfficeStudentDetailsPageProps = {
  user: LoginResponse;
  studentId: number;
  onLogout: () => void;
  onBack: () => void;
  onOpenStudentAttendance: () => void;
  onOpenStudentGradebook: () => void;
  onOpenStudentPersonalData: () => void;
  onOpenResits: () => void;
...
export function OfficeStudentDetailsPage({
  user,
  studentId,
  onLogout,
  onBack,
  onOpenStudentAttendance,
  onOpenStudentGradebook,
  onOpenStudentPersonalData,
  onOpenResits,
  onOpenAttendance,
  onOpenFinalSheets,
  onOpenStudents,
  onOpenAnalytics
}: OfficeStudentDetailsPageProps) {
  ...
  useEffect(() => {
    async function loadStudent() {
      try {
        ...
        setError(
          err instanceof Error ? err.message : "Ошибка загрузки карточки студента"
        );
      } finally {
        setIsLoading(false);
      }
  ...
  return (
    <div className="schedule-layout">
      ...
      <main className="office-student-details-content">
        ...
        {isLoading && <div className="schedule-state">Загружаем студента...</div>}
